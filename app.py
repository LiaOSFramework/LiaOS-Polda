...
# ===== FUNCTION ANALISIS 5 LAYER LIAOS =====
def analisis_liaos(narasi):
    return {
        "Layer 0 - Intent": "Deteksi niat narasi: gugatan/kritik kebijakan.",
        "Layer 1 - Bias": "Bias konfirmasi terhadap isu harga BBM.",
        "Layer 2 - Refleksi": "Narasi memancing emosi kemarahan.",
        "Layer 3 - Emosi": "Frustrasi, ketidakpercayaan pada pemerintah.",
        "Layer 4 - Reframing": "Soroti transparansi dan solusi alternatif."
    }
...
# ===== SIDEBAR =====
menu = st.sidebar.radio("Navigasi", ["Beranda", "Scan Narasi", "Riwayat Analisis", "Rekomendasi Respon", "Feed Narasi Viral", "Export PDF", "Pengaturan"])
...
# ===== SCAN NARASI =====
    ...
    if st.button("Analisis Sekarang"):
        if narasi_input.strip():
            hasil = analisis_liaos(narasi_input)
            for layer, analisis in hasil.items():
...
# ===== PENGATURAN =====
    ...
    st.write("Atur API Key OpenAI di menu Secrets Streamlit untuk mengaktifkan analisis AI langsung.")
